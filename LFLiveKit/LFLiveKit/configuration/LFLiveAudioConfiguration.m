...
+ (instancetype)defaultConfiguration {
    LFLiveAudioConfiguration *audioConfig = [LFLiveAudioConfiguration defaultConfigurationForQuality:LFLiveAudioQuality_Low_Low];
    return audioConfig;
}
...
+ (instancetype)defaultConfigurationForQuality:(LFLiveAudioQuality)audioQuality {
    ...
    switch (audioQuality) {
        case LFLiveAudioQuality_Low_Low: {
            audioConfig.audioBitrate = audioConfig.numberOfChannels == 1 ? LFLiveAudioBitRate_16Kbps : LFLiveAudioBitRate_32Kbps;
            audioConfig.audioSampleRate = LFLiveAudioSampleRate_8000Hz;
        }
            break;
    ...
    audioConfig.audioCodecType = LFLiveAudioCodecType_PCM;
    return audioConfig;
}
...
+ (instancetype)amrConfiguration {
    ...
    audioConfig.audioBitrate = audioConfig.numberOfChannels == 1 ? LFLiveAudioBitRate_16Kbps : LFLiveAudioBitRate_32Kbps;
            audioConfig.audioSampleRate = LFLiveAudioSampleRate_8000Hz;
    audioConfig.audioCodecType = LFLiveAudioCodecType_AMR;
    return audioConfig;
}
...
+ (instancetype)aacConfiguration {
    ...
    audioConfig.audioCodecType = LFLiveAudioCodecType_AAC;
    audioConfig.sendProtcol = LFLiveSendProtcol_RTSP;
    return audioConfig;
}
...
- (NSUInteger)bufferLength{
    switch(self.audioCodecType){
        case LFLiveAudioCodecType_PCM:
            return 64*2*self.numberOfChannels;
            break;
