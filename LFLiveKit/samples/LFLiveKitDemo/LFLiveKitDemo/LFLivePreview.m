...
- (LFLiveSession *)session {
    if (!_session) {
        ...
        _session = [[LFLiveSession alloc] initWithAudioConfiguration:[LFLiveAudioConfiguration defaultConfiguration] videoConfiguration:[LFLiveVideoConfiguration defaultConfiguration] captureType:LFLiveCaptureMaskAudio];
    ...
    if (!_startLiveButton) {
        ...
        [_startLiveButton addBlockForControlEvents:UIControlEventTouchUpInside block:^(id sender) {
            ...
            if (_self.startLiveButton.selected) {
                ...
                stream.url = @"rtmp://52.81.58.110/live/2c31494d_1563331876_audio";
