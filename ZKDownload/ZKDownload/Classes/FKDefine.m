...
FKTaskInfoName const FKTaskInfoUserInfo         = @"FKTaskInfoUserInfo";
FKTaskInfoName const FKTaskInfoDescribe         = @"FKTaskInfoDescribe";
FKTaskInfoName const FKTaskInfoMediaType        = @"FKTaskInfoMediaType";
