...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/A4xBaseExtensionKit/A4xBaseExtensionKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/A4xYogaKit/A4xYogaKit.framework"
  install_framework "${PODS_ROOT}/../ADDXWebRTC/Frameworks/frameworks/WebRTC.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ADDXWebRTC/ADDXWebRTC.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ADVideoMessageManager/ADVideoMessageManager.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ZKDownload/ZKDownload.framework"
