...
public extension NumberFormatter{
    ...
    static func identify(_ identify:String) -> NumberFormatter {
    ...
    static func format(_ identify:String, format: String) -> NumberFormatter {
    ...
    static func numStyle(_ numberStyle:NumberFormatter.Style, number: Any) -> String? {
