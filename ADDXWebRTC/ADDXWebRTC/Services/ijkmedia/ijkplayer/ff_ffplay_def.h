...
// -------add record start-------
     ...
     int is_record;                      // 是否在录制
     bool is_first_keyframe_recorded;    // 第一个I帧是否被录制
     int record_error;

     int is_first;                       // 第一帧数据
     int64_t audio_start_pts;            // 音频第一帧pts
     int64_t audio_start_dts;            // 音频第一帧dts
     int64_t video_start_pts;            // 视频第一帧pts
     int64_t video_start_dts;            // 视频第一帧dts
// -------add record end-------
} FFPlayer;
