...
static void message_loop_n(JNIEnv *env, IjkMediaPlayer *mp)
{
    ...
    while (1) {
        ...
        case FFP_MSG_ERROR_RTMP_URL_NOT_FOUND:
            MPTRACE("FFP_MSG_ERROR_RTMP_URL_NOT_FOUND:\n");
            post_event(env, weak_thiz, MEDIA_ERROR, MEDIA_ERROR_IJK_PLAYER_RTMP_URL_NOT_FOUND, 0);
            break;
        ...
        case FFP_MSG_BUFFERING_BYTES_UPDATE:
            MPTRACE("FFP_MSG_BUFFERING_BYTES_UPDATE:\n");
            post_event(env, weak_thiz, MEDIA_BUFFERING_BYTES_UPDATE, msg.arg1, msg.arg2);
            // ALOGE("FFP_MSG_BUFFERING_BYTES_UPDATE: %d\n", msg.arg1);
            break;
