...
@interface ADMediaAssetExportSession()
...
@implementation ADMediaAssetExportSession
...
- (void)convertInputAssets
{
    /*
     ...
     May be nil.
     */
    NSURL *temporaryDirectoryURL = [[NSFileManager defaultManager] adCreateUniqueTemporaryDirectory];
    ...
    else NSLog(@"The video stream's FPS should always be retrieved");
    ...
    {
        NSLog(@"Cannot delete temporary directory. Will be deleted automatically later. Error:%@", error);
    }
}
