...
class PlayerViewController: A4xBaseViewController {
    // 设备id
    var deviceId: String?
...
// 凹 - 直播控制器层回调处理
extension PlayerViewController: A4xPlayerStateChangeProtocol {
...
extension PlayerViewController: A4xPlayerView_DemoProtocol {
    // 重连
